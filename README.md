...
## About this app
This application is a new Flutter application that I have developed. You can check from the name that it is just a blog adding and saving application.
Also, it is a fully functional app with Firebase backend. 
...
## Code of Conduct
We follow certain guidelines to maintain this repository. Please find our [code of conduct](https://github.com/himanshusharma89/Flutter-Blog-App/blob/master/CODE_OF_CONDUCT.md) and read it carefully.
